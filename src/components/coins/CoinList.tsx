      ...
      <div className="flex items-center justify-between border-b border-roman-stone/15 bg-roman-paper px-4 py-2">
        ...
        <label className="flex items-center gap-2 text-sm text-roman-charcoal">
          ...
          <select
            ...
            className="rounded border border-roman-stone/25 bg-roman-paper px-2 py-1 text-sm focus:border-roman-red focus:outline-none"
          >
          ...
          <tbody className="divide-y divide-roman-stone/10">
            {sorted.map((coin) => (
              <tr
                ...
                tabIndex={0}
                className="cursor-pointer transition-colors hover:bg-roman-parchment/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-inset focus-visible:outline-roman-red"
              >
                <td className="max-w-52 truncate px-4 py-2 font-medium text-roman-charcoal">
