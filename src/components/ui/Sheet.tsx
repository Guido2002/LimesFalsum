...
export function Sheet({ open, onClose, title, children }: SheetProps) {
  ...
  return (
    <div
      ...
      aria-modal="false"
      aria-label={title}
      className="fixed inset-x-0 bottom-0 z-30 flex max-h-[72vh] flex-col rounded-t-xl border-t border-roman-stone/25 bg-roman-paper shadow-2xl"
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto border-t border-roman-stone/15">{children}</div>
    </div>
  );
}
